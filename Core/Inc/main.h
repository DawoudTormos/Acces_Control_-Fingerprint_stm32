...
#define TOUCH_SENS_Pin GPIO_PIN_1
#define TOUCH_SENS_GPIO_Port GPIOB
#define MD_EN_Pin GPIO_PIN_13
#define MD_EN_GPIO_Port GPIOB
#define MD_IN2_Pin GPIO_PIN_14
#define MD_IN2_GPIO_Port GPIOB
#define MD_IN1_Pin GPIO_PIN_15
#define MD_IN1_GPIO_Port GPIOB
#define FP_RX_Pin GPIO_PIN_9
#define FP_RX_GPIO_Port GPIOA
#define FP_TX_Pin GPIO_PIN_10
#define FP_TX_GPIO_Port GPIOA
#define FP_IRQ_Pin GPIO_PIN_4
#define FP_IRQ_GPIO_Port GPIOB
#define FP_IRQ_EXTI_IRQn EXTI4_IRQn
